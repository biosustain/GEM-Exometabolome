%% RESOS test - EcoliK12 (iJ0366 model)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% JUNE 2022 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
∞~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ RESOS
...
%%
disp('RESOS') %NOTE! The RESOS was modified to return only ERs and SLs - not triplets. 
...
%condition3 = sum(cellfun(@isnan,BMReduction{3,1}(:,4))) == size(BMReduction{3,1},1);
            if  condition1 && condition2 && condition3
                disp('Performing RESOS with original model, simplified model was too constrained')
                  samplingTime = 10;
                  tic

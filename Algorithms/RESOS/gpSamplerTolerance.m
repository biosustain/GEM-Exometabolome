function [sampleStructOut, mixedFrac] = gpSamplerTolerance(sampleStruct, nPoints, bias, maxTime, maxSteps, threads, nPointsCheck)
%%%%%%%%%%%%%%%%%%%% Modified by Fernando Silva-Lance 2021 %%%%%%%%%%%%%%%
%Creates warmup points with a varying feasibility tolerance if the model is too
%constraint. 

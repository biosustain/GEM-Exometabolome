function [Jsl,Jdl,Jtl] = parallelSL_2(model,cutoff,eliList)
...
if exist('eliList', 'var')
    if isempty(eliList)
        eliList = model.rxns(find(model.c)); %To eliminate ATPM.
    end
else

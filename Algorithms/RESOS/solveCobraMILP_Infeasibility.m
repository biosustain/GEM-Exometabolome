function solution = solveCobraMILP_Infeasibility(MILPproblem, NumberFocusParam,FeasibilityTolParam,varargin)
...
switch solver
    ...
    case 'gurobi'
        ...
        %ModifiedHere
        %MODIFICATION
        params.NumericFocus = NumberFocusParam;
        params.FeasibilityTol = FeasibilityTolParam;
